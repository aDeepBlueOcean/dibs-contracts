...
describe("PairRewarder", () => {
  ...
  it("should set top referrers correctly", async () => {
    ...
    const winner1wins = await pairRewarder.userLeaderBoardWins(winner1.address);
    const winner2wins = await pairRewarder.userLeaderBoardWins(winner2.address);
  ...
  it("should correctly set winner on multiple days", async () => {
    ...
    const winner1wins = await pairRewarder.userLeaderBoardWins(winner1.address);
    const winner2wins = await pairRewarder.userLeaderBoardWins(winner2.address);
    const winner3wins = await pairRewarder.userLeaderBoardWins(winner3.address);
